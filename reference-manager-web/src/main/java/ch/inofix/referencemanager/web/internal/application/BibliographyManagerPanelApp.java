...
public class BibliographyManagerPanelApp extends BasePanelApp {

    @Override
    public String getPortletId() {
        return PortletKeys.BIBLIOGRAPHY_MANAGER;
    }

    @Override
    @Reference(target = "(javax.portlet.name=" + PortletKeys.BIBLIOGRAPHY_MANAGER + ")", unbind = "-")
